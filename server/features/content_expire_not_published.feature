Feature: Content Expiry Not Published Items
  ...
  Scenario: Item in a package.
    ...
    """
    {"_items": [
      {"_id": "123", "type": "text", "linked_in_packages": [], "_current_version": 1}
    ]}
    """
    ...
    """
    {"_items": [
      {"_id": "123", "type": "text", "linked_in_packages": [{"package": "#package2#"}], "_current_version": 1},
  ...
  Scenario: Item in a takes package and take is also in a package.
    ...
    {
      "_items": [
      {"_id": "package2", "type": "composite", "headline": "test package", "state": "in_progress",
       "_current_version": 2,
       "groups": [
          {
              "id" : "root",
